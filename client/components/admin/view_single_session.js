...
class ViewSingleSession extends Component {
          ...
          <pre>
            <div className="form-group">
              ...
              <div className="checkbox">
                <label>
                  <input type="checkbox" disabled ref="morning" defaultChecked={morningSession} />
                  Morning Session Done
                </label>
              </div>
              <div className="checkbox disabled">
                <label>
                  <input type="checkbox" disabled ref="evening" defaultChecked={eveningSession} />
                  Evening Session Done
                </label>
              </div>
              <div><label>Journal</label></div>
              <textarea disabled className="form-control" ref="journal" rows="4" defaultValue={journalEntry} />
            </div>
